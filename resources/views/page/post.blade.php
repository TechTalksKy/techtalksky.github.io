...
<div class="row">
                <div class="col-xs-12 single-content">
                    <p class="meta">
                        <a class href="{{ URL::to('category.html') }}">James Reddy</a> in <a class href="{{ URL::to('category.html') }}">Storytime</a> <i class="link-spacer"></i> <i class="fa fa-bookmark"></i> 23 minute read
                    </p>
